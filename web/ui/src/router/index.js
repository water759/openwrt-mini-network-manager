...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'logs', name: 'logs', component: () => import('@/views/SystemLogsView.vue'), meta: { title: '系统日志' } },
      { path: 'report', name: 'report', component: () => import('@/views/TrafficReportView.vue'), meta: { title: '流量报表' } },
      { path: 'alerts', name: 'alerts', component: () => import('@/views/AlertHistoryView.vue'), meta: { title: '告警历史' } },
